...
const initialState = {
  sections: {
    ...
    Cart: {
      ...
      images: ["../static/wiki_photos/cart/cart_1.jpg"]
    },
    "Checkout Process": {
      subheadings: [
        {
          name: "Access",
          content:
            "The checkout page can be accessed in 2 different ways: Open the cart and click the &=> button at the bottom of the cart. or Click the &=> button when viewing a product in the shop or product detail page."
        },
        {
        ...
        {
          name: "Payment",
          content: `This is the final and most important step. Review your order details in the three windows at the top. If there are any mistakes, go back and correct them in the previous steps. Once you verify that the information is correct, you will be able to select a payment method from the options below. For more information on payments see the &=># section of this documentation.`
        }
      ],
      images: [
        "../static/wiki_photos/checkout/checkout_button.jpg",
        "../static/wiki_photos/checkout/buy_now.jpg",
        "../static/wiki_photos/checkout/coupon_code.jpg",

        "../static/wiki_photos/checkout/ty_next.jpg",
        // "../static/wiki_photos/checkout/product_preview.jpg",
        "../static/wiki_photos/checkout/shipping_method.jpg",
        "../static/wiki_photos/checkout/load_profile.jpg",
        "../static/wiki_photos/checkout/delete_profiles.jpg",
        "../static/wiki_photos/checkout/save_profile.jpg",
        "../static/wiki_photos/checkout/different_billing_address.jpg"
      ]
    },
    "Compare Page": {
      subheadings: [
      ...
      images: [
        "../static/wiki_photos/compare/compare_search.jpg",
        "../static/wiki_photos/compare/compare_strains.jpg"
      ]
    },
    Payment: {
      subheadings: [
    ...
    "Product Page": {
      subheadings: [
        {
          name: "Access",
          content:
            "Each product has its own page and can be accessed by clicking its link on the shop page or by typing in www.cropkingseeds.com/product/name-of-strain (where “name-of-strain” is replaced by the name of the strain you’re looking for with each word separated by hyphens, i.e. www.cropkingseeds.com/product/haze-xtreme-regular)"
        },
        {
          name: "Strains Menu",
          content:
      ...
      images: [
        "../static/wiki_photos/product/strains_tab.jpg",
        "../static/wiki_photos/product/add_to_cart_module.jpg"
      ]
    },
    Shop: {
      subheadings: [
      ...
      images: [
        "../static/wiki_photos/shop/search_bar.jpg",
        "../static/wiki_photos/shop/filter_heading.jpg",
        "../static/wiki_photos/shop/filters.jpg",
        "../static/wiki_photos/shop/active_filters.jpg",
        "../static/wiki_photos/shop/sort.jpg",
        "../static/wiki_photos/shop/product_details_shop.jpg",
        "../static/wiki_photos/shop/add_to_cart_button.jpg",
        "../static/wiki_photos/shop/link_product.jpg"
        // "../static/wiki_photos/shop/add_to_cart_shop.jpg",
      ]
    },
    "Tips And Tricks": {
      subheadings: [
