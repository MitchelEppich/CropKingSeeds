...
const initialState = {
    steps: [
        {
            ...
            progressImage: "../static/img/seed1.png",
            instruction:
        ...
        },
        {
            ...
            progressImage: "../static/img/seed2.png",
            instruction:
        ...
        },
        {
            ...
            progressImage: "../static/img/seed3.png",
            instruction:
    ...
    currentStep: 0,
    carouselPositions: ["translateX(600px)", "translateX(-930px)", "translateX(-2460px)"]
};
