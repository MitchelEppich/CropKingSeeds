...
const initialState = {
  questions: [
    ...
    {
      question:
        "What is the price of shipping? And what are appropriate delivery times?",
      answer: [
  ...
  switch (action.type) {
    case actionTypes.TOGGLE_FAQ_QUESTION:
      return updateObject(state, {
        currentlyExpanded:
          state.currentlyExpanded == action.index ? null : action.index
      });
    case actionTypes.SET_FAQ_SEARCH:
      return updateObject(state, {
        searchValue: action.value
      });
    case actionTypes.SET_QUESTIONS_COUNT:
      return updateObject(state, {
