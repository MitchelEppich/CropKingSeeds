info = [
  {
    sotiId: "BBR",
    info: [
      "This Indica - dominant plant has purplish buds, which is what earned it its moniker in the first place. The leaves are vibrant and colorful and usually, grow in a unique fan-like arrangement. Meanwhile, Blueberry buds are among the best you can get your hands on today. They have a delicious and tempting flavor that leaves a tantalizing aftertaste that lasts an incredibly long time. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Haze Xtreme is easy to moderate growth. This huge - yielding plant can be grown indoors and outdoors, with a difference of about 200g in terms of yield. The flowering time is anywhere between two to two and a half months, and yields can go up to 550g(indoors; outdoor estimated yield is 350g). ",
  ...
  },
  {
    sotiId: "AFR",
    info: [
      "Crowd favorite Afghani is a high - yield strain that is very potent and delivers a lasting high like no other. Extremely high on THC, this Indica - dominant original landrace strain gives way for a relaxing and happy high that works for both new and experienced users any time of day. This is the perfect smoke to cap the night because its body buzz, which is a signature Indica effect, will surely glue you to your bed while soothing and calming your tired muscles. ",
      ...
      "The yield is equally remarkable, reaching 500g when grown indoors and 300g outdoors. These are hefty amounts, given that every tiny part of Afghani’s huge, gorgeous, sparkling buds is absolutely packed with stinky and pungent goodness and a kind of satisfying body high you rarely ever get to find. They are unbelievably vibrant and dense. You would be surprised how much a single bud could weigh. ",
      ...
      "Order cannabis seeds yourself some of these babies, and be prepared to harvest impressively huge yields of beautiful, sticky, and stinky buds after a few months. Afghani is definitely worth all the work you put into it. "
    ]
  },
  {
    sotiId: "OSR",
    info: [
      "Our take on the classic favorite Original Skunk lives up to its name. This stinky plant announces its full, pungent presence from miles away, and boy, do you want to soak yourself in that aroma. This strain has THC levels reaching over 15%. Although this figure is not as high as those of other strains, the Original Skunk is favored and patronized anyway by users and growers alike because of its unique characteristics and amazing effects. ",
      "First of all, the Original Skunk does not cause overly psychedelic effects. The high is mainly good body buzz, momentarily keeping you glued to the couch while keeping your muscles and limbs soothed and calm. ",
      ...
      "Outdoors, this plant has been known to produce as much as 250g of yield. That number becomes 400g if you grow them indoors. These numbers may not be as large as those of other strains, but you would be amazed upon seeing your first couple of Original Skunk buds. Each one is a fat, frosty, resin - rich golf ball - like a bud that reeks nothing but awesomeness. ",
  ...
  },
  {
    ...
    info: [
      ...
      "When grown in an indoor environment, you can expect a yield which is up, reaching up to 400g. On the other hand, if you grow them in their most favorite climate outdoors, you can expect about 400 gr at the end of harvest time. This means that this is perfect for growing for those who would like to see a good amount of yield without having to worry too much about taking care of the plants, monitoring them every now and then. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Thanks to its indica dominance, this strain only grows to a manageable height. In fact, it grows short to medium in stature, which means that it is suited for those who are planning to grow this strain in an indoor setup and do not have enough headspace. ",
  ...
  },
  {
    ...
    info: [
      ...
      "If grown outdoors, Durban Poison can yield up to 350g. Indoors, that number shoots up to 550g as you have the full control of your indoor grow. This is not bad, considering how much you get out of every particle of the buds of this marijuana strain. The developing buds alone during flowering are already tempting enough. ",
  ...
  },
  {
    ...
    info: [
      ...
      "The estimated flowering time for our Sour Jack cannabis strain is 9 weeks, and the yield is as heavy as its expected effect. Indoors, this strain can produce up to 500g of yield, whereas outdoors, this plant can yield up to 300g of fat, dense buds covered from bottom to tip with tempting crystals. You might be wondering why Sour Jack grown indoors seem to produce bigger yields than those grown outdoors. Well, you have the full control of your cannabis plant and environment if done indoors so you can actually get bigger yields if you are doing it just right. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Its yield is quite typical of our strains. At 500g(indoors) and 300g(outdoors), Cali OG Kush is a sure heavyweight. At more than 24%, the THC content of this strain can’t be dismissed. That is an extremely high number, and you can expect only the best kind of high from it. ",
      ...
      "As an uplifting strain, Cali OG Kush is the ideal remedy for those days spent poring over office documents, fulfilling boring work tasks, and participating in meetings that suck the life and enjoyment out of you. Simply have a taste of this strain, and you should spend the next hours happily, slowly recharging as your mind forgets about your bad mood and stress. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Dark Angel is the offspring of crowd favorites Cheese and Jack Herer. When growing this plant outdoors, you can expect yields amounting to around 350 g. Indoors, a single Dark Angel plant can give you up to 550g of trichome- filled deliciousness. ",
      ...
      "We recommend Dark Angel for growers who would like to have an interesting, versatile, and easy grow in their garden. This strain caters to both medical and non - medical marijuana patients, and it combines some of the best effects of its parent strains. This is a quality that you can rarely find elsewhere. "
    ]
  },
  {
    sotiId: "PKF",
    info: [
      ...
      "Capable of thriving both indoors and outdoors, this strain is classified as an easy to moderate grow. Flowering takes an average length of time, and the yields are fantastic. Indoors, this plant can produce up to 400g of dense orange- ish purple buds. Outdoors, that number becomes 250 g. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Black Indica is a high - yielding strain. Outdoors, yields can reach 200g. Indoors, that figure shoots up to 400g. This is not a particularly difficult plant to grow or care for. You can expect maximum yield just by ensuring the best growing conditions. This strain has a moderate amount of THC(12.94%) and a high percentage of CBD(2.5%). ",
  ...
  },
  {
    ...
    info: [
      ...
      "The THC content of Hash Plant is not too high at just a little over 12%, but the CBD level is impressively substantial at 3.5%. The yields are also quite good. Indoors, this plant can produce yields weighing up to 300g. Outdoors, the maximum yield is 150g. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Measured at 19. 25%, the THC content of White Cookies can be anywhere from moderate to high. The yields are quite impressive, ranging from 200g to 400g when grown outdoors and indoors, respectively. These figures make White Cookies one of the largest yielding cannabis strains available on the market today. ",
  ...
  },
  {
    ...
    info: [
      ...
      "The THC content of our Bubba Kush is 17. 79%, and CBD content is 1.20%. This offspring of the classics Bubble Gum and Original Kush can produce yields weighing up to 500g indoors and 300g indoors. These are extremely large numbers, which are what you definitely want in your grow area. ",
  ...
  },
  {
    ...
    info: [
      ...
      "This is a high - yield strain that produces up to 600g indoors and 300g outdoors. These are extremely large numbers relative to the yields common among other strains. Green Crack is an offspring of superstars Afghani and Skunk, so you definitely can’t go wrong with this strain. ",
  ...
  },
  {
    sotiId: "SGA",
    info: [
      "Sour Girl is an amazing combination of three interesting strains – Early Girl, Sour Diesel, and Ruderalis. Thus, it exhibits characteristics that are evident as coming from both powerful strains. One thing that makes this strain standout is the fact that it offers a generous density, together with a gassy, complex aroma that can easily get in your face. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Lambs Breath is also endowed with a unique and distinct aroma. You can immediately sense its skunky and cheesy smell, which is often associated with the smell of fresh tobacco. It features some hints of woody, sour and piney flavors, which are all pungent smells. The smoke, however, is different from its aroma, as it features creamy and sweet elements that do not just make the smoke delicious but pleasurable at the same time. ",
      "If you are planning to grow this plant, what you will notice immediately is that the buds are remarkable, not because of the strange color, but because they radiate vibrant and pure green. The buds are also big enough, which can ensure a harvest of buds that are filled with frosty trichomes all over. "
    ]
  },
  {
    sotiId: "WWA",
    info: [
      ...
      "Indoors, this strain is expected to produce up to 250g worth of weed; outdoors, it can yield up to 150g. The high THC content of the Original White Widow is retained perfectly well here at 21.10%, and the CBD percentage is sizable at 0.70%. Indeed, our auto-flowering feminized White Widow is out to blow minds all the way from Spain. ",
  ...
  },
  {
    sotiId: "CCA",
    info: [
      "You can’t possibly be any luckier than this. This Candy Cane variant is an autoflowering feminized one that is categorized as an easy or moderate growth.The flowering time is amazingly short at merely 7 weeks, and this strain can grow indoors and outdoors. This variant is mostly Indica(60%) and partly Sativa(30%) and Ruderalis(10%). ",
      "Nothing makes these seeds more attractive than their potency. Measuring more than 17%, their THC content ranges anywhere from moderate to high. Yield is not bad either at 200g and 100g indoors and outdoors, respectively. Regarding genetics, Candy Cane is the offspring of AK47, Mango, and White Widow. ",
      "This strain got its name for an obvious reason: it is incredibly sweet. Its scent and flavor are both fruity and exotic at the same time. Candy Cane has these characteristics that are unique and unmistakably it's own. ",
  ...
  },
  {
    sotiId: "REA",
    info: [
      "Just like most of our other autoflowering marijuana strains, Revolver Autoflowering is easy to moderate growth. The flowering time is merely 7 glorious weeks, which is a lot shorter than those of most strains. A cross between NY City Diesel and Original White Widow, this strain is 70% Indica, 20% Sativa, and 10% Ruderalis. ",
  ...
  },
  {
    sotiId: "EMA",
    info: [
      "Thriving in both indoor and outdoor grows, our fast autoflowering Early Miss is easy to moderate growth. It flowers in a relatively short time too, taking merely 7 weeks. In that short amount of time, you will be greeted by thick buds with way more resin than you can ever imagine. ",
      "A cross between crowd favorites Big Bud and Original White Widow, Early Miss is also a Spanish strain that is predominantly Indica(60%). A small percentage is shared by its Sativa(30%) and Ruderalis(10%) roots. The yield of this plant is amazing, especially relative to other autoflowering strains. Outdoors, you can expect to have up to 100g in yield; indoors, that figure shoots up to 200g. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Like many of the best strains you can get absolutely high on today, this Jack Herer comes all the way from beautiful Spain. A dominant Sativa, this strain is guaranteed to deliver the kind of high that its class has become known for among growers and users alike. ",
      "At 16.25%, the THC content of Jack Herer autoflowering ranges from moderate to high. Meanwhile, this is 70% Sativa, 20% Indica, and 10% Ruderalis.In terms of yield, Jack Herer does not do bad at all. It can produce up to 150g worth of yield outdoors and up to 250g indoors. ",
      "This version of Jack Herer has an uplifting effect. This is the perfect smoke for those days you just want to forget about stuff for a moment and kick back for a couple of hours. Just a few hits and you should find yourself in absolute relaxation, ending with a cool and refreshed mind and a bright disposition. ",
  ...
  },
  {
    ...
    info: [
      ...
      "These beauties also vary a lot in terms of genetics, but all of them come from either the Netherlands or Spain, which means they are nothing short of premium quality. In terms of THC content, they can be anywhere from low to high(10.85% to 24% to be exact). When it comes to yield, though, they do not vary that much. These plants can yield anywhere between 100g and 250g, and that still depends on whether they are grown indoors or outdoors. ",
  ...
  },
  {
    sotiId: "FMM",
    info: [
      "Regardless if you are a new or experienced marijuana grower, we are sure you already know the sheer quantity of a variety of the strains available on the market today. With this wide range of choices, buying marijuana seeds in Canada can be hard. Instead of spending precious minutes trying to come up with a decision of which strain to grow, why not order this special mix & match pack from us? ",
      ...
      "Needless to say, flowering period length, difficulty, and effects vary too. Some of these seeds are classified as “very easy” grows, whereas some are moderate grows. Yields can be anywhere from 450g to 500g per plant, and that quantity depends on the growing area or medium. ",
  ...
  },
  {
    ...
    info: [
      ...
      "These babies may be small, but boy, do they deliver. This autoflowering strain is known to produce large yields. Outdoors, you can get up to 150g out of this. Indoors, you can expect that number to go up to 250g. "
    ]
  },
  {
    sotiId: "AHA",
    info: [
      "All marijuana lovers deserve to have their favorite strain as easily as possible. This is what inspired us to add Amnesia Haze in the autoflowering form to our existing product lines. This Sativa dominant beauty is easy to moderate growth that takes merely 8 or 9 weeks to fully flower and can thrive both indoors and outdoors.  ",
      ...
      "Measured at 15.50%, the THC content of this Spanish strain is at a moderate level. The CBD level is also quite high at 1.21%. Indeed, this plant is not only dank in scent and taste but also in purpose. The yield is quite attractive too. When grown outdoors, this Amnesia Haze autoflower can give you up to 150g worth of yummy, dense yield. When grown indoors, this strain can yield up to 250g. ",
      "The effect of our Amnesia Haze autoflower is mainly uplifting. This is why it is also used by medical marijuana users suffering from anxiety and heavy stress. This strain can also be used to combat headaches and boost creativity. This is therefore perfect for those days when you need to get a lot done well. There is also a bit of a psychedelic effect. ",
  ...
  },
  {
    ...
    info: [
      ...
      "Watch this thing grow its majestic branches and leaves in just a few short weeks and let it flower for merely 7 more weeks. Its fat buds glistening from all those trichome crystals and oozing with yummy resin is sure worth all the wait. Expect to have up to 150g of these dank buds when growing outdoors and up to 250g if growing indoors. ",
