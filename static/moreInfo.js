info = [
  {
    sotiId: "BBR",
    info: [
      "This Indica - dominant plant has purplish buds, which is what earned it its monicker in the first place. The leaves are vibrant and colorful and usually grow in a unique fan - like arrangement. Meanwhile, Blueberry buds are among the best you can get your hands on today. They have a delicious and tempting!avor that leaves a tantalizing aftertaste that lasts an incredibly long time. ",
      ...
      "This award - winning strain is recommended for growers wanting to work with an easy to moderate grow. The flowering time is merely more or less two months, which is about the same as that of many other common strains. Just make sure to use the right and only the best nutrients because this strain can be a little picky. "
    ]
  },
  {
    sotiId: "HXR",
  ...
  },
  {
    ...
    info: [
      ...
      "The yield is equally remarkable, reaching 500 g when grown indoors and 300 g outdoors. These are hefty amounts, given that every tiny part of Afghani’s huge, gorgeous, sparkling buds is absolutely packed with stinky and pungent goodness and a kind of satisfying body high you rarely ever get to find. They are unbelievably vibrant and dense. You would be surprised how much a single bud could weigh. ",
