    ...
    return (
        <div className="w-full mt-6 pb-6">
            ...
            <div className="w-full">
                ...
                <div className="w-full p-2">
                    <div className="flex lg:flex-wrap md:flex-wrap sm:flex-wrap lg:justify-center mt-4 h-250 xl:h-200 lg:h-500 md:h-600 sm:h-650">
                        ...
                        <div className="w-1/3 sm:w-full md:w-full sm:hidden md:hidden lg:hidden">
                        ...
                        <div className="w-1/3 lg:w-full sm:w-full md:w-full xxl:hidden xl:hidden">
                            <p className="p-2 w-full text-justify px-6">{content}</p>
                            <p className="text-center font-bold text-xl mt-12 ">{date}</p>
                        </div>
                    </div>
            ...
            <div className="w-full mt-24">
                <div>
                    <h3 className="font-extrabold text-center mb-8 text-3/5xl text-grey-light uppercase">Who We Are</h3>
                </div>
