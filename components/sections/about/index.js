    ...
    let historyThumbnails = props.about.historyObjs.map((val, index) => {
        ...
        return (
            <div
                ...
                <img style={activeThumb} src={val.imgSrc} className="w-full h-full about-img shadow-md" />
            </div>
        );
    });
    ...
    let whoWeAre = props.about.whoWeAre.map((val, index) => {
        return (
            <div key={index} className="w-250 md:my-5 sm:my-5 flex flex-wrap justify-center content-start ">
                <img className="h-200 w-200 rounded-full border-8 border-grey-lighter scale-item" src={val.src} />
    ...
    return (
        <div className="w-full mt-3 pb-6">
            <div className="font-bold text-2xl">
                <h1 className="text-3/5xl font-extrabold mb-6 p-2 text-center">About Us</h1>
            </div>
                ...
                <div className="w-full pb-6 px-4">
                    <div className="flex lg:flex-wrap md:flex-wrap sm:flex-wrap lg:justify-center mt-4 h-250 xl:h-full lg:h-full md:h-full sm:h-full">
                        ...
                        <div className="w-1/3 sm:w-full md:w-full sm:hidden md:hidden lg:hidden relative">
                            ...
                            <p className="text-center font-bold text-xl mt-12 absolute pin-b pin-x">{date}</p>
                        </div>
            ...
            <div className="w-full mt-24">
                <div>
                    <h3 className="font-extrabold text-center mb-8 text-3xl text-grey-light uppercase">Who We Are</h3>
                </div>
