...
const About = props => {
  ...
  let whoWeAre = props.about.whoWeAre.map((val, index) => {
    return (
      <div
        key={index}
        className="w-250 md:my-5 sm:my-5 flex flex-wrap justify-center content-start p-4"
      >
        <img
  ...
  return (
    <div className="w-full mt-3 pb-6">
      ...
      <div className="w-full bg-white rounded overflow-hidden mt-20">
        <div>
          <h3 className="font-extrabold text-center text-3xl uppercase p-2 bg-grey-lightest shadow text-grey-light opacity-75">
            History
          </h3>
        </div>
      ...
      <div className="w-full mt-24">
        <div>
          <h3 className="font-extrabold bg-smoke-grey text-center mb-8 p-2 rounded opacity-75 text-3xl text-grey-light uppercase">
            Who We Are
          </h3>
        </div>
