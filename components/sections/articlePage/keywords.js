    ...
    <div className="w-full p-2 px-6 border-t-2 border-grey-lightest">
      ...
      <div className="text-sm w-full text-left">
        <ul className="inline-flex cursor-pointer ml-0 pl-0">
          <li className="text-grey scale-item mx-1">Cannabis,</li>
          <li className="text-grey scale-item mx-1">Growing,</li>
          <li className="text-grey scale-item mx-1">How To,</li>
          <li className="text-grey scale-item mx-1">Marijuana Seeds</li>
        </ul>
      </div>
    </div>
  );
