...
import { faClock, faUserAlt, faEnvelope, faPrint } from "@fortawesome/free-solid-svg-icons";
import { faFacebook, faInstagram, faTwitter, faGooglePlus, faLinkedin } from "@fortawesome/free-brands-svg-icons";
    ...
    return (
        <div>
            <div className="text-white bg-black-transparent p-6">
                ...
                <h1 className="font-extrabold text-3/5xl">How to Grow Indica in Winter</h1>
            ...
            <div className="bg-white">
                <p className="px-4 py-6 text-grey-light italic">
                    Young rats injected with a synthetic cannabinoid have more of the brain’s motivating dopaminergic
                    signaling and fewer numbers of inhibitory neurons than controls.
                </p>
                ...
                <div className="w-full inline-flex flex-wrap">
                    <div className="md:w-full sm:w-full w-3/5">
                        <p className="text-content p-6 text-justify">
                            ...
                            fugiat nulla pariatur. sunt in culpa qui officia deserunt mollit anim id est laborum. Ut
                    ...
                    <div className="md:w-full sm:w-full w-2/5 p-6">
                        <img src="../../static/img/cannabis.jpg" style={imgStyle} className="w-full" />
                        <p className="px-6 py-2 text-sm text-grey-light text-center">
                            Cannabis image description here. <span>(Photo by Albert Einstein)</span>
                        </p>
                    </div>
                </div>
                <p className="text-content p-6 pt-0 text-justify">
                    Ut enim adminim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                    consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat
                    nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
