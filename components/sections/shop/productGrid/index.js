          ...
          <div
            ...
            className={
              hoverId == product._id
                ...
                : "w-64 h-64 sm:cursor-pointer md:cursor-pointer sm:w-32 sm:h-32 md:w-44 md:h-48 lg:h-48 lg:w-44 text-white relative z-0 slowishish lg:my-4 sm:my-2 md:my-2 lg:mx-1 xl:mx-4 xxl:my-4 xxl:mx-8"
            }
          >
            <ProductThumbnail
