  ...
  render() {
        ...
        >
          <div style={overlayStyle}>
            ...
            <div
              className={
                hoverId == product._id
                  ? "flex flex-wrap justify-between px-4 slow"
                  : "opacity-0 slow"
              }
            >
              <button
                ...
                className={
                  this.props.misc.quickAddToCartQty === 0
                    ? "bg-red-dark text-white w-16 rounded-lg flex flex-wrap text-center justify-center leading-normal shadow-md mx-2 font-bold"
                    : "bg-white text-black w-16 rounded-lg flex flex-wrap text-center justify-center leading-normal shadow-md mx-2 font-bold"
                }
              >
                5
                <span
              ...
              <button
                className="bg-red-dark rounded-lg text-center text-white mx-auto m-4 p-4"
                onClick={() => {
                  console.log(
                    product.sotiId +
                      (() => {
    ...
    return (
      <div className="w-3/4 min-h-500 text-white">
        <div className="flex flex-wrap justify-start pt-16">{products}</div>
      </div>
    );
  }
}
