...
import { faExternalLinkAlt, faSeedling, faClock, faTimes, faCheck } from "@fortawesome/free-solid-svg-icons";
...
const productThumbnail = props => {
    ...
    let showRating = () => {
        ...
        totalReviews = props.product.review == null ? 0 : props.product.review.length;
          ...
          ${hover ? "cursor-pointer fa-2x text-grey-light absolute z-50 pin-t pin-r mt-3 mr-3" : "hidden"} `}
            ...
            <Link prefetch href="/product" as={"/product/" + props.product.name.toLowerCase().replace(/ /g, "-")}>
                <div className="cursor-pointer xxl:pt-4">
                    <div
                        ...
                        onClick={e => {
                            if (props.isSmallMediumOrLargeDevice || props.supportedBrowser.browser == "firefox") {
                                e.preventDefault();
            ...
            <div
                ...
                <div className="text-center w-full pt-8">
                    <p className={hover ? "text-grey my-3 sm:my-0 slow font-extrabold text-sm" : "hidden slow"}>
                ...
                <div
                    ...
                    <div className="w-1/2 mr-1 border-grey-lightest border pb-2">
                        <p className="text-xs font-bold text-grey p-2 bg-grey-lightest">Price per Pack:</p>{" "}
                    ...
                    <div className="w-1/2 ml-1 border-grey-lightest border pb-2">
                        <p className="text-xs font-bold text-grey p-2 bg-grey-lightest">Total Price:</p>
                        <p className="text-lg pt-2 font-bold text-grey px-2">
                            {currency != null
                                ? `${currency.symbol}${(
                                      currency.convert *
                ...
                <div className={hover ? "w-full mx-auto text-center p-1" : "hidden slow"}>
                    <p className="text-sm italic font-extrabold pt-2 text-red-dark text-right mr-24">In stock</p>
                </div>
            </div>
        </div>
    );
