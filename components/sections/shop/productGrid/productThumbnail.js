        ...
        <div className={overlayClass}>
          ...
          ${hover ? "cursor-pointer fa-2x text-grey-light absolute z-50 pin-t pin-r mt-3 mr-3" : "hidden"} `}
            ...
            <div
                ...
                <img className={packagePins} src="../static/img/strains/pins/OrangeCrown_150.png" />
            </div>
            ...
            <div
                ...
                <div className={hover ? "w-full mx-auto text-center p-1" : "hidden slow"}>
                    <p className="text-sm italic font-extrabold pt-2 text-red-dark text-right mr-6">In stock</p>
                </div>
            </div>
        </div>
    );
