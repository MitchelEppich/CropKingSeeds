...
import { faSeedling, faClock, faEnvelope, faPrint } from "@fortawesome/free-solid-svg-icons";
...
const productThumbnail = props => {
    ...
    return (
        <div
            ...
            <div className={props.hoverId == props.product._id ? "w-full bg-white" : "relative"}>
                <Link href="/viewProduct" as={"/product/" + props.product.name.toLowerCase().replace(/ /g, "-")}>
                ...
                <div className={props.hoverId == props.product._id ? "text-grey px-6 p-2 text-sm" : "hidden slow"}>
                    <Link href="/viewProduct" as={"/product/" + props.product.name.toLowerCase().replace(/ /g, "-")}>
                ...
                <div
                    ...
                    <div className="w-1/2 ml-1 bg-grey-lightest pb-2">
                        ...
                        <p className="text-2xl text-grey px-2">
                            $
                            {(props.product.price[props.shop.quickAddToCartQty] * props.cart.potentialQuantity).toFixed(
                                2
                            )}
                        </p>
                    </div>
                </div>
                <div className={props.hoverId == props.product._id ? "w-full mx-auto text-center p-1" : "hidden slow"}>
