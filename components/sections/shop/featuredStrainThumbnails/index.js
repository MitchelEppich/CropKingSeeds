...
const index = props => {
  ...
  return (
    <div className="flex bg-grey-lightest flex-wrap w-full pt-6 sm:justify-center md:justify-center lg:justify-start xl:justify-start xxl:justify-around sm:overflow-hidden">
