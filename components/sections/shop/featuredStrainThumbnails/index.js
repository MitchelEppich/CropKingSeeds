...
const index = props => {
    ...
    let products = props.page == "product" ? props.misc.relatedStrains : props.misc.featuredStrains;
    ...
    let max = props.specificMax == null ? products.length : Math.min(products.length, props.specificMax);
            ...
            <div className="w-container mt-2 mx-auto">
                {count < max && props.page == "shop" ? (
                    <p
                        ...
                        Load More <FontAwesomeIcon icon={faAngleDown} className="fa-lg ml-2" />
                    </p>
