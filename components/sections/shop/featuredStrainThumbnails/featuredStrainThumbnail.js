...
const FeaturedStrainThumbnail = props => {
    ...
    let featuredStrainsPackage = hover ? "featuredStrainsPackage--hover" : "featuredStrainsPackage";
    let featuredStrainsPlant = hover ? "featuredStrainsPlant--hover" : "featuredStrainsPlant";
    let overlayClass = hover ? "overlayClass--hover" : "overlayClass";
    let packagePins = hover ? "featuredStrainsPackage-pins--hover" : "featuredStrainsPackage-pins";
    ...
    let showMoreText = {
        transform: hover ? "translateX(0px) translateY(32px)" : "translateX(-450px) translateY(32px)",
    ...
    return (
        <div className="w-full h-full cursor-pointer">
            ...
            <div
                ...
                See More Information <span className="ml-3 text-xl items-center flex pt-1">></span>
            </div>
