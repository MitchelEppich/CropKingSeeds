...
const BannerCarousel = props => {
    ...
    banners = banners.map((banner, index) => {
        ...
        if (props.misc.activeBannerSlide + index >= props.misc.bannerSlidePositions.length) {
            positionIndex = props.misc.activeBannerSlide + index - props.misc.bannerSlidePositions.length;
        }
        return (
            <div key={index}>
                ...
                <div className="w-full">
                    {" "}
                    <Slide {...props} {...banner} position={props.misc.activeBannerSlide} index={index} />
                </div>
                <div
                    onClick={() => {
                        props.changeBannerSlide({
    ...
    return (
        <div className="w-full">
            ...
            <div className="w-full block justify-center flex p-3 mb-2 opacity-75">{bullets}</div>
        </div>
    );
};
