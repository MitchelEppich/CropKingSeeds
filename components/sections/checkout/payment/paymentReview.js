...
const PaymentReview = props => {
    ...
    if (
        ...
        (_orderDetails[pageGroup].productList != null && _orderDetails[pageGroup].productList.value != productList)
    ) {
        // Product Information
        ...
        couponActive = _orderDetails.coupon != null && _orderDetails.coupon.code != null;
        ccFeeActive = _orderDetails[pageGroup].creditFee != null && _orderDetails[pageGroup].creditFee.value != 0;
    }
        ...
        <div className="w-full flex justify-end mb-6 lg:flex-col md:flex-col sm:flex-col">
            <div
                ...
                <div className="p-2">
                    ...
                    <p className="mt-2">
                        {_orderDetails.shipping != null ? (
                            <span>
                                ...
                                {_orderDetails.shipping.state ? ", " + _orderDetails.shipping.state.value : null}
                            </span>
                        ) : (
                            "Not Defined"
                        )}
                    ...
                    <p className="mt-2">
                        {_orderDetails.shipping != null ? _orderDetails.shipping.postalZip.value : "Not Defined"}
                    </p>

                    <p className="mt-2">
                        {_orderDetails.shipping != null ? _orderDetails.shipping.country.value : "Not Defined"}
                    </p>
                    ...
                    <p className="mt-2">
                        ...
                        {_orderDetails.shipping != null ? _orderDetails.shipping.phone.value : "Not Defined"}
                    </p>
            ...
            <div
                ...
                <div className="p-2">
                    ...
                    <p className="mt-2">
                        {_orderDetails.billing != null ? (
                            <span>
                                ...
                                {_orderDetails.billing.state ? ", " + _orderDetails.billing.state.value : null}
                            </span>
                        ) : (
                            "Not Defined"
                        )}
                    ...
                    <p className="mt-2">
                        {_orderDetails.billing != null ? _orderDetails.billing.postalZip.value : "Not Defined"}
                    </p>

                    <p className="mt-2">
                        {_orderDetails.billing != null ? _orderDetails.billing.country.value : "Not Defined"}
                    </p>
                    ...
                    <p className="mt-2">
                        ...
                        {_orderDetails.billing != null ? _orderDetails.billing.phone.value : "Not Defined"}
                    </p>
            ...
            <div
                ...
                <div className="p-2 inline-flex w-full">
                    <div className="w-3/5 text-right">
                        ...
                        {_orderDetails[pageGroup].creditFee.value != 0 ? (
                            <p className="mt-2">
                                Credit Card Tax ({(_orderDetails[pageGroup].creditTax * 100).toFixed(2)}%):{" "}
                            </p>
                        ) : null}
                        ...
                        <p className="mt-2">Tax ({(_orderDetails[pageGroup].cumTax * 100).toFixed(2)}%):</p>
                    </div>
                    <div className="w-2/5 pl-4 text-left">
                        <p className="mt-1">
                            {currency != null
                                ? `${currency.symbol}${(
                                      currency.convert *
                                      (_orderDetails[pageGroup].cartTotal.value + _orderDetails[pageGroup].discount)
                                  ).toFixed(2)}`
                                : ""}
                        </p>
                        <p className="mt-2">
                            {_orderDetails[pageGroup].shippingFee.value != 0
                                ? currency != null
                                    ? `${currency.symbol}${(
                                          currency.convert * _orderDetails[pageGroup].shippingFee.value
                                      ).toFixed(2)}`
                                    : ""
                                : "FREE"}
                        </p>
                        ...
                        <p className="mt-2">
                            {currency != null
                                ? `${currency.symbol}${(currency.convert * _orderDetails[pageGroup].taxFee).toFixed(2)}`
                                : ""}
                        </p>
                    </div>
                </div>
                <div
                    className={`${
                        couponActive && ccFeeActive ? "p-1" : ccFeeActive | couponActive ? "p-2 mt-5" : "p-2 mt-12"
...
let buildProductList = items => {
    ...
    for (let key of Object.keys(items)) {
        ...
        let _name = `${product.sotiId}${item.amount} - ${product.name} ${product.genetic} Cannabis Seeds (${
            item.amount
        } Seeds)`;
