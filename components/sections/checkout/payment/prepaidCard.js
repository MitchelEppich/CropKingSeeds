            ...
            <img src="../static/img/cards.png" width="100px" />
                            ...
                            <select
                                ...
                                value={
                                    ...
                                    props.checkout.orderDetails[pageGroup].ccExpireMonth != null
                                        ? props.checkout.orderDetails[pageGroup].ccExpireMonth.value || ""
                                        : undefined
                                }
                                onChange={e => {
                                    let _orderDetails = props.checkout.orderDetails;
                            ...
                            <select
                                ...
                                value={
                                    ...
                                    props.checkout.orderDetails[pageGroup].ccExpireYear != null
                                        ? props.checkout.orderDetails[pageGroup].ccExpireYear.value || ""
                                        : undefined
                                }
                                onChange={e => {
                                    let _orderDetails = props.checkout.orderDetails;
                                ...
                                {(() => {
                                    ...
                                    for (let i = 0; i < 10; i++) {
                                        ...
                                        arr.push(<option value={_year.toString().slice(2)}>{_year}</option>);
                                    }
                                    return arr;
                                })()}
                            </select>
                    ...
                    <div className="w-200 p-2 mx-auto mt-6 text-center">
                        <p className="text-center p-2 font-extrabold bg-red-dark text-white hover:bg-grey-light cursor-pointer rounded">
                            <button name="prepaidCreditPay" type="submit" className="font-bold text-white">
                                Pay Now
                            </button>
                        </p>
                    </div>
