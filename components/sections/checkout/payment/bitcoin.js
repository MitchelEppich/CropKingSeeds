...
const Bitcoin = props => {
    ...
    return (
        <div className="w-full mb-6">
            ...
            {props.misc.visibleScreen != null && props.misc.visibleScreen.includes("payment::bitcoin") ? (
                <div className="w-full p-2">
                    <div className="w-full mt-2 text-center">
                        <p className="text-sm p-2">Proceeding will take you to Bitcoin to log in to your account.</p>
                        <img src="../static/img/bitcoin_logo.png" width="200px" className="mt-4 cursor-pointer" />
                    </div>
                    <div className="w-full mt-2 text-center text-md">{showBitcoinData()}</div>
