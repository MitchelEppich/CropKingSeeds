...
const Transfer = props => {
    ...
    return (
        <div className="w-full mb-6 ">
            <div
                onClick={() => {
                    props.setVisibleScreen({ input: "etransfer", group: "payment" });
            ...
            {props.misc.visibleScreen != null && props.misc.visibleScreen.includes("payment::etransfer") ? (
                <div className="w-full p-2">
                    <div className="w-full mt-2 text-center">
                        <p className="text-sm p-2">
                            Proceeding will take you to the instructions on how to send an E-Transfer.
                        </p>
                    </div>
