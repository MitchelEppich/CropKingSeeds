...
const Cash = props => {
    ...
    return (
        <div className="w-full mb-6 ">
            <div
                onClick={() => {
                    props.setVisibleScreen({ input: "cash", group: "payment" });
                ...
                <div className="w-4/5 p-2 flex items-center">
                    <p className="sm:text-sm md:text-sm">Pay with Cash</p>
                </div>
            ...
            {props.misc.visibleScreen != null && props.misc.visibleScreen.includes("payment::cash") ? (
