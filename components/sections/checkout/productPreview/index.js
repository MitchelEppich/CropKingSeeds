...
const ProductPreview = props => {
    ...
    let showProducts = () => {
        ...
        for (let item of Object.keys(_items)) {
            ...
            _arr.push(
                <div key={item} style={{ width: "48%" }} className="inline-flex relative mx-2 mt-4 item-preview">
                    ...
                    <div className="mt-1 p-2 pt-2 w-3/5 relative">
                        <h3 className="px-2 h-10 text-2xl font-bold inline">{_product.name}</h3>
                        ...
                        <p className="px-2 pt-4 font-medium text-grey-light text-md">{_item.amount} Packs</p>
                        <p className="px-2 pt-2 font-medium text-grey-light text-md">{_product.type}</p>
                        <p className="px-2 pt-2 font-medium text-grey-light text-md">${_item.per.toFixed(2)}</p>
                ...
                /> */}
                                <div className="w-100 flex justify-between h-6 items-center">
                                    ...
                                    <p className="leading-none font-semibold text-xl">{_item.quantity}</p>
                                    <button
                                        onClick={() =>
                                            props.modifyCart({
                                                items: props.cart.items,
                            ...
                            <div style={{ borderRadius: "5px" }} className="text-grey-light text-center">
    ...
    return (
        <div className="w-full mt-6 mb-8">
            <h2 className="text-3/5xl font-extrabold mt-12 mb-6 text-black">Shopping Cart</h2>
            <div className="w-full inline-flex flex-wrap mb-4 mt-2">{showProducts()}</div>
        </div>
    );
};
