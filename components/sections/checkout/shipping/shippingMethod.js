const ShippingMethod = props => {
    ...
    let showMethods = () => {
        if (props.checkout.orderDetails.shipping.country == null || props.checkout.orderDetails.shipping.state == null)
            return (
                <div>
                                        ...
                                        <input
                                            ...
                                            checked={
                                                ...
                                                props.checkout.orderDetails[pageGroup].shippingCost != null
                                                    ? props.checkout.orderDetails[pageGroup].shippingCost.value ==
                                                      _method.price
                                                    : false
                                            }
                                            onChange={e => {
                            ...
                            <div className="w-1/8 sm:w-full sm:mt-4 sm:flex sm:justify-end">
                                <div className="text-2xl text-red-light font-extrabold">
                                    ...
                                    props.checkout.orderDetails.shipping.state == null
                                        ...
                                        : _method.price != 0
                                        ? currency != null
                                            ? `${currency.symbol}${(currency.convert * _method.price).toFixed(2)}`
                                            : ""
                                        : "FREE"}
                                </div>
                            </div>
    ...
    return (
        <div
            ...
            <h2 className="text-3/5xl font-extrabold opacity-50 mt-8 mb-4 text-black">Shipping Method</h2>
            {showMethods()}
        </div>
    );
};
