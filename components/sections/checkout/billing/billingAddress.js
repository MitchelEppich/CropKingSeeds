...
const BillingAddress = props => {
    ...
    if (
        ...
        props.checkout.orderDetails.shipping.updatedAt != props.checkout.orderDetails[pageGroup].updatedAt
    ) {
        let _orderDetails = props.checkout.orderDetails;
    ...
    return (
        <div className="w-full mt-6 px-8 sm:px-4">
            <h2 className="text-3/5xl font-extrabold opacity-50 mt-8 mb-4 text-black">Billing Address</h2>
            ...
            <div
                className={`w-full mt-4 ${
                    props.checkout.orderDetails[pageGroup].readOnly ? "opacity-50 pointer-events-none unselectable" : ""
                }`}>
