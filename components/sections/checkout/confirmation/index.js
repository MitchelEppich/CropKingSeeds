...
const Confirmation = props => {
    ...
    let showProduct = () => {
        ...
        for (let item of Object.keys(_items)) {
            ...
            arr.push(
                <div key={arr} className="w-full inline-flex my-1 shadow-md h-full bg-white items-center flex p-2">
                    ...
                    <div className="w-3/5">
                        <div className="p-2 font-bold text-lg items-center md:text-left sm:text-left lg:text-left flex">
                            <a
                                ...
                                href={href + "/product/" + _item.product.name.toLowerCase().replace(/ /g, "-")}
                                target="_blank">
                                {_item.product.name} - {_item.amount} Seeds
                            </a>
                        </div>
                    </div>
                    <div className="w-1/5 p-2 font-bold text-lg items-center justify-center flex">{_item.quantity}</div>
                    <div className="w-1/5 p-2 font-bold text-lg items-center justify-center flex">
                        {currency != null ? `${currency.symbol}${(currency.convert * _item.price).toFixed(2)}` : ""}
                    </div>
                </div>
            );
        }
    ...
    return (
        <div className="w-full mt-6 text-center">
            <div>
                <img src="../static/img/cks-confirmation.png" className="text-center" width="200px" />
                <h1 className="text-3/5xl font-bold mt-4 mb-4 text-black">Thank You!</h1>
                <h4 className="font-extrabold p-2 text-2xl">Your order has been placed.</h4>
                <p className="text-red-light font-bold text-xl">Please follow payment instructions below.</p>
            </div>
            <div className="xxl:w-container mx-auto pt-12 w-main">
                ...
                <div className="w-full inline-flex text-lg bg-white p-2 pb-6 shadow-md lg:flex-col sm:flex-col md:flex-col">
                    ...
                    <div className="w-1/3 p-2 text-left sm:w-full md:w-full lg:w-full lg:text-center sm:text-center md:text-center sm:border-b-2 lg:border-b-2 md:border-b-2 border-grey-lightest sm:py-6 md:py-6 lg:py-6">
                        ...
                        <p>
                            ...
                            {_orderDetails.shipping.apartment ? _orderDetails.shipping.apartment.value : null}{" "}
                        </p>
                        <p>{_orderDetails.shipping.postalZip.value}</p>
                        <p>
                            {_orderDetails.shipping.city.value}, {_orderDetails.shipping.country.value}
                        </p>
                    </div>
              ...
              Shipping Details:
                                ...
                                <div className="mt-10">
                                    ...
                                    <div className="bg-white shadow-md">
                                        <p className="w-main mx-auto pt-4">
                                            To ensure that your cash order is successfully recieved please document your
                                            order number (<strong>{fOrderId}</strong>) on a piece of paper, along side
                                            the requested amount in applicable currency:
                                        </p>
                                        ...
                                        <p className="mt-4 p-2 text-center pb-4">
                                            It is recommended that you wrap any cash within your mail (in newspaper,
                                            charcoal paper or tin foil) to ensure privacy.
                                        </p>
                                    </div>
                                </div>
                            );
                            ...
                            return (
                                <div className="mt-10">
                                    ...
                                    <div className="bg-white shadow-md">
                                        ...
                                        <p className="mt-4 p-2 text-center pb-4">
                                            <strong>Important</strong>: Interac E-Transfers may take a few hours to be
                                            approved. Once a payment is successfully recieved we will ship your order on
                                            the next applicable business day.
                                            <br />
                                            To ensure your order is shipped as soon as possible, please call us to
                                ...
                                <div className="mt-10">
                                    ...
                                    <div className="bg-white shadow-md">
                                        <p className="w-main mx-auto py-4">
                                            To complete your payment with BitCoin, a new tab has been opened in which
                                            you can proceed to finalize your payment.
                                            <br />
                                            <br />
                                        ...
                                        <p className="text-center p-2 mt-4 text-xl">
                                            {_ccr.status == "Declined" ? (
                                                <span>
                                                    ...
                                                    <br />
                                                    Please immediately call our customer support (at +1 (844) 276 -
                                                    7546) to resolve any issues.
                                                    <br />
                                                    Once your payment has been recieved we will ship your order on the
                                                    next applicable business day.
                                                </span>
                                            ) : (
                                                <span>
                                                    Please allow some time for your payment to process, once your
                                                    payment has been recieved we will ship your order on the next
                                                    applicable business day.
                                                </span>
                                            )}
                                        </p>
                                        <p className="mt-4 p-2 text-center pb-4">
                                            <strong>Important</strong>: The displayed order total may vary depending on
                                            fluctuations in conversion rates and bank processing fees. All charges will
                                            show up as '{_ccr.descriptor}' on your credit card statement once
                                            successfully processed.
                                            <br />
                                            If you have any concerns or issues please contact our customer service
                ...
                <div style={sectionTitle} className="w-full inline-flex mt-8 bg-red-light text-white font-bold p-1">
                    <div className="w-3/5 px-4 p-2 uppercase text-left font-bold text-lg">Product</div>
                        ...
                        <div className="inline-flex w-500 xl:w-full sm:w-full md:w-full lg:w-full">
                            <div className="w-2/5 sm:w-3/5 md:w-3/5 lg:w-3/5 xl:w-4/5 text-right">
                                ...
                                {_orderDetails.payment.creditFee.value != 0 ? (
                                    <p className="p-1">
                                        Credit Card Tax ({(_orderDetails.payment.creditTax * 100).toFixed(2)}%):
                                    </p>
                                ) : null}
                                {_orderDetails.coupon != null && _orderDetails.coupon.code != null ? (
                                    <p className="p-1 text-red-dark">Discount ({_orderDetails.payment.discountAmt}):</p>
                                ) : null}
                                <p className="p-1">Tax ({(_orderDetails.payment.cumTax * 100).toFixed(2)}%):</p>
                            ...
                            <div className="w-2/5 xl:w-1/5 xl:text-right text-left sm:text-right md:text-right lg:text-right lg:mr-2 xl:mr-8">
                                <p className="p-1">
                                    {currency != null
                                        ? `${currency.symbol}${(
                                              currency.convert *
                                              (_orderDetails.payment.cartTotal.value + _orderDetails.payment.discount)
                                          ).toFixed(2)}`
                                        : ""}
                                </p>
                                <p className="p-1">
                                ...
                                {_orderDetails.payment.creditFee.value != 0 ? (
                                    <p className="p-1">
                                        {currency != null
                                            ? `${currency.symbol}${(
                                                  currency.convert * _orderDetails.payment.creditFee.value
                                              ).toFixed(2)}`
                                            : ""}
                                    </p>
                                ) : null}
