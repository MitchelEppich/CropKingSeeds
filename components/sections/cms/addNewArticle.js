        ...
        <div className="h-full w-full">
          ...
          /> */}
                ...
                <div className="inline-flex font-bold items-center flex w-full mt-4">
                    ...
                    <button className="p-2 bg-red-light rounded text-white font-bold mr-2">Marijuana Seeds</button>
                    <button className="p-2 bg-red-light rounded text-white font-bold mx-2">Purple Kush</button>
                    <button className="p-2 bg-red-light rounded text-white font-bold ml-2">CKS Seeds</button>
                </div>
            </div>
        </div>
    );
