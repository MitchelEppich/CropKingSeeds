...
const Partners = props => {
    console.log(props.partner.partners)
    let showPartners = () => {
    ...
    return (
        ...
        <div className="w-2/3 p-2 pl-8">
            ...
            <p>If your company has the same high standards as Crop King Seeds, then contact us to put your information in the list below.</p>
        </div>
