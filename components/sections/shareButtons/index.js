...
import { faFacebook, faInstagram, faTwitter, faRedditSquare, faGooglePlus } from "@fortawesome/free-brands-svg-icons";
    ...
    return (
        <div className="fixed pin-l mt-32 z-999 md:hidden sm:hidden ">
            <div
                ...
                <a className="text-white" target="_blank" href="https://www.instagram.com/cropkingseeds/?hl=en">
                    <FontAwesomeIcon
                        icon={faInstagram}
                        className="fa-2x my-1 pr-1 hover:text-red-dark scale-item cursor-pointer"
                    />
                </a>
                <a className="text-white" target="_blank" href="https://www.facebook.com/cropkingseedsreview/">
                    <FontAwesomeIcon
                        icon={faFacebook}
                        className="fa-2x my-1 pr-1 hover:text-red-dark scale-item cursor-pointer"
                    />
