  ...
  return (
    <div className="mt-6 w-full mx-auto bg-grey-lightest flex flex-wrap content-start">
      <div className="w-full bg-white xxl:inline-flex xl:inline-flex block border border-grey-lightest rounded overflow-hidden">
        <div className="xxl:w-1/3 w-full border-r border-grey-lightest sm:border-0 md:border-0 lg:border-0">
        ...
        <div className="xxl:w-1/3 w-full border-l sm:border-0 md:border-0 lg:border-0  sm:pt-2 sm:mt-3 sm:border-t-4 sm:border-grey-lightest md:pt-2 md:mt-3 md:border-t-4 border-grey-lightest ">
          {" "}
          <Details {...props} />
        </div>
      </div>
