...
const data = props => {
    ...
    let data = [
        ...
        _product.sativa != null || _product.sativa * 100 > 0 || _product.sativa != 0
            ...
            : null,
        _product.ruderalis != null || _product.ruderalis * 100 > 0 || _product.ruderalis != 0
            ? {
                  id: "Ruderalis",
                  label: "Ruderalis",
            ...
            <div className="w-full bg-white xxl:inline-flex block">
                ...
                <div className="xxl:w-1/3 w-full bg-white sm:pt-2 sm:mt-3 sm:border-t-4 sm:border-grey-lightest md:pt-2 md:mt-3 md:border-t-4 md:border-grey-lightest relative pb-6">
                    <div className="bg-red-light w-full">
                        <h3 className="text-white font-bold p-2 text-center uppercase">Strain Info</h3>
                    </div>
                    <div className="w-full mb-10">
                            ...
                            <div className="relative bg-smoke-grey w-full rounded-lg">
                                <div className="inline-flex absolute w-full h-full">
                                    <div className="absolute flex w-full h-full justify-end">
                                        <p className="text-grey my-auto text-xs font-bold pr-8 sm:pr-1 z-40">{pthc}</p>
                                    </div>
                                    <div
                                        className={
                                            _product.thc == "low"
                        ...
                        <div className="w-full p-1 px-4 flex text-white justify-start my-1  inline-flex">
                            ...
                            <div className="relative bg-smoke-grey w-full rounded-lg">
                                <div className="inline-flex absolute w-full h-full">
                                    <div className="absolute flex w-full h-full justify-end">
                                        <p className="text-grey my-auto text-xs font-bold pr-8 sm:pr-1 z-40">{pcbd}</p>
                                    </div>
                                    <div
                                        className={
                                            _product.cbd == "low"
                        ...
                        {_product.pcbn[1] > 0 ? (
                            <div className="w-full p-1 px-4 flex text-white justify-start my-1  inline-flex">
                                <div className="text-black font-bold my-1 mr-2 w-10 py-1">CBN:</div>
                                <div className="relative bg-smoke-grey w-full rounded-lg">
                                    <div className="inline-flex absolute w-full h-full">
                                        <div className="absolute flex w-full h-full justify-end">
                                        ...
                                        <div
                                            className={"bg-purple h-full pl-2 px-2 text-xs flex items-center absolute"}
                                            style={{
                                                width: pcbnWidth,
                                                borderRadius: "5px",
                                                overflow: "hidden"
