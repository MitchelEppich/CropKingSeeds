    ...
    <div className="mt-1 p-2">
      <div className="flex xl:block lg:block md:block sm:block mt-6">
        <div className="flex flex-wrap w-2/3 justify-start xl:w-full lg:w-full md:w-full sm:w-full">
          <div className="w-200 mx-2 sm:w-1/2 text-center leading-tight border-grey-lightest border">
        ...
        <div className="w-200 mx-2 text-center leading-tight border-grey-lightest border xl:block lg:block xl:w-full lg:w-full md:block md:w-full sm:block sm:w-full">
          <p className="mb-1 p-1 font-bold bg-smoke-grey text-grey uppercase">
            Effects:
          </p>
