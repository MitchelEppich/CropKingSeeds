...
const Details = props => {
    ...
    return (
        <div className="bg-smoke-grey">
            <div style={{ background: "#128671" }} className="w-full border-b-8 border-white">
                <h3 className="text-white font-bold p-2 text-center uppercase">Extra Info</h3>
            </div>
                ...
                <div className="w-full">
                    <div className="w-full inline-flex items-center flex pl-6 bg-white mb-1">
                        <div className="w-16 inline-flex">
                            <div style={{ background: "#128671" }} className="p-1 text-white w-10 h-10 ml-2 m-1">
                                <FontAwesomeIcon icon={faClock} className="fa-2x p-1" />
                            </div>
                        </div>
                        <div className="w-full p-2 xl:text-sm lg:text-sm md:text-sm sm:text-sm">
                            <p className="font-bold text-sm pl-6 uppercase">{_product.flowerTime}</p>
                        </div>
                    </div>
                    <div className="w-full inline-flex items-center flex pl-6 bg-white mb-1">
                        <div className="w-16 inline-flex items-center flex">
                            <div style={{ background: "#086554" }} className="p-1 text-white w-10 h-10 ml-2 m-1">
                        ...
                        <div className="w-full p-2 xl:text-sm lg:text-sm md:text-sm sm:text-sm">
                            <p className="font-bold text-sm pl-6 uppercase">
                                {" "}
                                {_product.yield[0] + " "} {_product.yield[1] > 0 ? "/" + _product.yield[1] : null}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="w-full inline-flex items-center flex pl-6 bg-white mb-1">
                        <div className="w-16 inline-flex items-center flex">
                            <div style={{ background: "#158442" }} className="p-1 text-white w-10 h-10 ml-2 m-1">
                                <FontAwesomeIcon icon={faChartLine} className="fa-2x p-1" />
                            </div>
                        </div>
                        <div className="w-full p-2 xl:text-sm lg:text-sm md:text-sm sm:text-sm">
                            <p className="font-bold text-sm pl-6 uppercase">{_product.difficulty}</p>
                        </div>
                    </div>

                    <div className="w-full inline-flex items-center flex pl-6 bg-white mb-1">
                        <div className="w-16 inline-flex items-center flex">
                            <div style={{ background: "#1cb058" }} className="p-1 text-white w-10 h-10 ml-2 m-1">
                                <FontAwesomeIcon icon={faGlobeAmericas} className="fa-2x p-1" />
                            </div>
                        </div>
                        <div className="w-full p-2 xl:text-sm lg:text-sm md:text-sm sm:text-sm">
                            <p className="font-bold text-sm pl-6 uppercase">{_product.country}</p>
                        </div>
                    </div>

                    <div className="w-full inline-flex items-center flex pl-6 bg-white mb-1">
                        <div className="w-16 inline-flex items-center flex">
                            <div style={{ background: "#23dc6e" }} className="p-1 text-white w-10 h-10 ml-2 m-1">
