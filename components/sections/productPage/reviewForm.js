  ...
  return (
    <form className="min-h-300 flex flex-wrap content-around">
      <div className="w-1/4">
        ...
        <div className="w-full pt-4 content-center flex justify-around px-12">
      ...
      <textarea placeholder={"What did you think about " + props.viewProduct.currentProduct.name + "?"} className="w-2/3 p-4 h-100 my-2 mx-4"></textarea>
