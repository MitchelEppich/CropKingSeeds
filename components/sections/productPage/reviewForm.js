        ...
        return (
            <form
                ...
                <div className="w-full">
                    <textarea
                        placeholder={"What did you think about " + this.props.viewProduct.currentProduct.name + "?"}
                        required
                        id="body"
                        maxLength=""
                        value={_review.body || ""}
                ...
                <div className="w-full inline-flex lg:flex-col flex-wrap sm:block md:block">
                    ...
                    <div className="w-2/5 lg:w-full lg:justify-center lg:my-2 sm:w-full justify-center mr-auto flex md:w-full md:justify-center">
                        <ReCAPTCHA sitekey="6LdVgJIUAAAAADf3mm-422DqVktwJJuPs5TB2578" ref="recaptchaRefReviews" />
                    </div>
                    <button
