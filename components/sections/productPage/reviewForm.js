...
const reviewForm = props => {
  return (
    <form className="min-h-300 flex flex-wrap content-around">
      ...
      <textarea placeholder={"What did you think about " + props.viewProduct.currentProduct.name + "?"} className="w-2/3 p-4 h-200 my-2 mx-auto"></textarea>
      <input className="w-1/3 mx-auto p-3" type="submit" />
