...
const reviews = props => {
    ...
    let reviews = _reviews.slice(reviewsPerPage * cursor, reviewsPerPage * (cursor + 1)).map((review, index) => {
    ...
    let showPages = () => {
        ...
        let pageCursor = Math.max(cursor < totalPages - 2 ? cursor - 2 : totalPages - 5, 0);
    ...
    return (
        <div className="w-full mx-auto pb-8 pt-6">
            <h3 className="w-full p-2 pl-6 font-bold text-3xl my-3 text-grey bg-smoke-grey">Customer Reviews</h3>
            ...
            <div className="mt-4">
                <h3 className="w-full p-2 pl-6 font-bold text-3xl my-3 text-grey bg-smoke-grey">Last Reviews</h3>
                <div
                    id="reviews"
                                ...
                                <div className="h-150 w-full flex items-center">
                                    <div className="w-full">
                                        <div className="w-full font-bold text-lg my-2">
                                            <p className="text-center">Looks like there are no reviews!</p>
                                        </div>
                                        <div className="w-full">
