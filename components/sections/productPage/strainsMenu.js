...
const strainsMenu = props => {
    ...
    strains = strains.map((strain, index) => {
        if (index == 0 || strains[index].genetic != strains[index - 1].genetic) headersPlacement.push(index);
        return (
            <Link
                key={index}
                href="/product"
        ...
        <div
            ...
            {Router.asPath.slice(1).includes("product/") ? (
                <div
                    ...
                    <p style={StrainText} className="font-bold text-white w-8 h-10 pt-4 uppercase pb-4">
                        Strains
                    </p>
                    <FontAwesomeIcon
                        icon={faCannabis}
            ...
            <div className="bg-white text-white relative -ml-1">
                ...
                <div className="overflow-y-auto h-screen w-full">
                    <p
                        className={`bg-${
                            props.detail.geneColor[_strains[headersPlacement[0]].genetic.toLowerCase()]
                    ...
                    <p
                        className={`bg-${
                            props.detail.geneColor[_strains[headersPlacement[1]].genetic.toLowerCase()]
                    ...
                    <p
                        className={`bg-${
                            props.detail.geneColor[_strains[headersPlacement[2]].genetic.toLowerCase()]
                        } p-3 font-bold text-center text-white text-shadow uppercase w-full`}>
                    ...
                    <p
                        className={`bg-${
                            props.detail.geneColor[_strains[headersPlacement[3]].genetic.toLowerCase()]
                        } p-3 font-bold text-center text-white text-shadow uppercase w-full`}>
                    ...
                    <p
                        className={`bg-${
                            props.detail.geneColor[_strains[headersPlacement[4]].genetic.toLowerCase()]
                        } p-3 font-bold text-center text-white text-shadow uppercase w-full`}>
                    ...
                    <p
                        className={`bg-${
                            props.detail.geneColor[_strains[headersPlacement[5]].genetic.toLowerCase()]
                        } p-3 font-bold text-center text-white text-shadow uppercase w-full`}>
