  ...
  return (
    <div className="xxl:mt-64 xxl:pt-48 xl:mt-12 lg:pt-0 md:pt-0 md:mt-0 lg:mt-12 w-full scale-item flex-wrap flex justify-around ">
      ...
      <div className="w-1/2 sm:w-full md:w-full py-2 px-10 mt-4 relative pb-8">
        <h2 className="px-2 lg:text-2xl sm:text-2xl text-3/5xl font-black">
          How to Grow Indica in Winter
        </h2>
        <h3 className="px-2 text-3xllg:text-lg ">
          Guide to Growing Cannabis off Season
        </h3>
        <p className="px-2">
        ...
        <div
          ...
          className="bg-red-darker font-bold rounded shadow-md text-white text-center p-3 w-32 mx-auto cursor-pointer absolute pin-b pin-x h-12 pt-4"
        >
          Read More
        </div>
      </div>
