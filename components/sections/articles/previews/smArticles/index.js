...
const SmArticles = props => {
    return (
        <div
            ...
            className="xl:w-300 md:w-250 md:mb-12 lg:w-250 text-center mx-6 my-4 relative scale-item">
            <div className="bg-white md:h-250 lg:h-250 h-500 xl:h-300 ">
                <img
                    className="h-250 md:h-125 lg:h-125 xl:h-150 w-full object-cover"
