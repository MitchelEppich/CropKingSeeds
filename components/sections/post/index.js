    ...
    return (
        <div style={{
            ...
            <div className="w-500 p-4">
                ...
                <h2 className="text-center font-bold text-4xl text-red">Germination</h2>
                ...
                <div style={{borderRadius: "5px", width: "100px"}}className="bg-red text-white p-2 flex items-center h-12 mx-auto cursor-pointer">Read More</div>
            </div>
