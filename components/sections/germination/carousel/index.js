...
const Carousel = props => {
  ...
  return (
    <div className="xl:w-95p lg:w-95p md:w-95p sm:w-full w-main mx-auto mt-24 md:mt-24 sm:mt-2 shadow-md sm:pt-4 sm:h-450 md:h-450 lg:h-350 xl:h-300 xxl:h-400 xl:pt-4 xxl:pt-12 text-xl relative overflow-hidden mx-auto bg-white">
