const Carousel = props => {
    ...
    console.log(props.misc.mediaSize);
    ...
    return (
        <div className="sm:w-full sm:pt-4 shadow-lg h-400 pt-12 text-xl relative overflow-hidden mx-auto bg-white">
            ...
            <div
                style={{
                    width: props.misc.mediaSize == "xxl" ? "3600px" : "2700px",
                    height: "340px",
                    top: "0",
                    position: "absolute",
                    transform:
                        "translateZ(1000px) " + props.misc.mediaSize == "xxl"
                            ? xxLXCarouselPositions[currentStep]
                            : carouselPositions[currentStep],
                    display: "flex",
