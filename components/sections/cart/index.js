        ...
        <div
            ...
            <div className="relative h-20 sm:h-16 w-full">
                <div className="absolute w-full">
                    <p
                        ...
                        <FontAwesomeIcon icon={faAngleDoubleRight} className="fa-lg sm:px-1" />
                    </p>
                    <h2
                        onClick={() =>
                            props.setVisibleScreen({
                ...
                {items.length > 0 ? (
                    <div className="justify-end flex mr-5 underline">
                        <div
                            ...
                            <FontAwesomeIcon icon={faTrash} className=" ml-2 items-center flex" />
                        </div>
                    </div>
                ) : null}
                {items.length > 0 ? (
                    ...
                    <div className="text-center text-base">
                        <p className="text-3xl mb-2 mt-64 sm:mt-48 font-extrabold">Sorry, your cart is empty!</p>
            ...
            <div className="pr-4 h-16 items-center flex bg-white text-red-dark flex absolute pin-b border-t-2 border-red-dark w-500 sm:w-full md:w-full">
                ...
                <div className="flex mr-4 items-center sm:mx-4">
                    <p className="inline-block mr-4 text-xl font-medium text-grey sm:text-lg">Subtotal:</p>
                    <p className="inline-block text-2xl font-extrabold sm:text-xl text-red-dark">
                        {currency != null
                            ? `${currency.symbol}${(currency.convert * props.cart.price).toFixed(2)}`
                            : ""}
                    </p>
                </div>
            </div>
