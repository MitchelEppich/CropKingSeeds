...
import { faLongArrowAltLeft, faLongArrowAltRight, faAngleDoubleRight } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="min-h-300 h-full w-full font-thin bg-smoke-grey overflow-y-auto pb-32">
                {items.length > 0 ? (
                    ...
                    <div className="text-center text-base">
                        <p className="text-3xl mb-2 mt-64 font-extrabold">Sorry, your cart is empty!</p>
