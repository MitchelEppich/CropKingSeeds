...
const Footer = props => {
    return (
        <div style={{ height: "230px" }} className="w-full mt-24 inline-flex bg-grey relative">
            {" "}
            <div style={{ width: "1300px" }} className="w-container mx-auto inline-flex">
                ...
                <div style={{ width: "25%" }} className="mt-6 pl-6">
                    <h3 className="text-yellow-dark pl-2 uppercase text-2xl font-extrabold">Menu</h3>
                    <ul className="text-white font-bold p-2 inline-flex">
                        <div className="mr-4">
                            <Link href="/about">
                                <li className="text-xl p-1 pt-3 hover:text-grey-light cursor-pointer">About</li>
                            </Link>
                            <Link href="/articles">
                                <li className="text-xl p-1 pt-3 hover:text-grey-light cursor-pointer">Articles</li>
                            </Link>
                            <Link href="/contact">
                                <li className="text-xl p-1 pt-3 hover:text-grey-light cursor-pointer">Contact Us</li>
                            </Link>
                            <Link href="/faq">
                                <li className="text-xl p-1 pt-3 hover:text-grey-light cursor-pointer">FAQ</li>
                            </Link>
                        </div>
                        <div className="ml-2">
                            <Link href="/privacy">
                            ...
                            <Link href="/partners">
                                <li className="text-xl p-1 pt-3 hover:text-grey-light cursor-pointer">Partners</li>
                            </Link>
                            <Link href="/affiliates">
                                <li className="text-xl p-1 pt-3 hover:text-grey-light cursor-pointer">Affiliates</li>
                            </Link>
                        </div>
                    </ul>
                </div>
                <div style={{ width: "35%" }} className="text-white text-center mx-6">
                    <h4 className="p-2 mt-4 mb-1 text-2/5xl font-extrabold">Subscribe to the CKS Newsletter</h4>
            ...
            Subscribe
                    ...
                    <p className="p-2 mt-4 w-container mx-auto text-center">Copyright © 2019 Crop King Seeds</p>
                </div>
                <div style={{ width: "20%" }} className="p-2 mr-4">
                    <div className="mt-4 text-white text-right">
                        <h3 className="text-yellow-dark font-extrabold text-2xl uppercase">Follow us</h3>
