...
const Footer = props => {
  return (
    <div className="w-full mt-24 inline-flex sm:block md:block lg:block bg-grey relative">
      {" "}
      <div className="mx-auto inline-flex sm:block md:block w-1300 sm:w-full md:w-full lg:w-full">
        ...
        <div
          ...
          <p className="p-2 mt-4 w-container mx-auto text-center sm:hidden md:hidden lg:hidden">
        ...
        <div className="p-2 mr-4 w-1/5 sm:w-full md:w-full lg:w-1/3 sm:mx-0 md:mx-0 sm:p-0 md:p-0 sm:block md:block md:mt-8 pt:mt-8 ">
          ...
          <div className="mt-10 text-right sm:text-center md:text-center lg:text-center">
