...
const SearchBar = props => {
    return (
        <form
            ...
            <div className="flex w-400 sm:w-full xl:w-225 lg:w-225 md:w-225 z-40 h-8 mt-1 bg-white border-0 text-grey rounded shadow-md">
                <SearchSuggest {...props} />{" "}
                <Link href="/shop" as={"/shop?" + props.misc.searchValue}>
                    <a
                        ...
                        className="bg-yellow-dark hover:bg-yellow slowish w-12 sm:w-16 border-0 pl-1 leading-loose z-999 rounded">
