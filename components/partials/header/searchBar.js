...
const SearchBar = props => {
    return (
        <form
            ...
            className="w-600 sm:w-full h-16 sm:mt-28 sm:mx-0 sm:px-2 mt-20 md:mt-40 md:pl-0 md:ml-16 pt-1 pl-40 xl:pl-40 lg:pl-40 ml-64 xl:ml-48 lg:ml-40 fixed z-50 sm:z-35 md:z-35">
