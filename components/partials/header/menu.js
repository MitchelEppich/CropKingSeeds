...
const menu = props => {
    ...
    return (
        <div style={menuStyle} className=" w-full bg-white h-20 inline-flex test">
            <div className="w-1/2 inline-flex">
                ...
                <div className="w-full mt-3">
                    <ul className="inline-flex w-full text-red-dark font-bold text-lg pt-2 pl-32">
                        <Link href="/shop">
                            <li className="px-2 py-1 mx-2 cursor-pointer text-2xl hover:text-red-darker">Shop</li>
                        </Link>
                        ...
                        <Link href="/articles">
                            <li className="px-2 py-1 mx-2 cursor-pointer text-2xl hover:text-red-darker">Articles</li>
                        </Link>
                    </ul>
                </div>
            </div>
            ...
            <div className="w-1/2 inline-flex">
                ...
                <div className="w-2/5 mt-2 text-center mt-4">
                    <p className="text-red-dark p-2 mt-2 text-lg font-extrabold">Call: 604-563-0291</p>
                </div>
                <div
                    onClick={() => {
