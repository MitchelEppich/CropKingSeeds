...
import { faSearch, faShoppingCart, faDollarSign } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div
            ...
            <div style={{ background: "rgba(93, 9, 9, 0.71)" }} className="w-full h-12">
                <div style={{ marginTop: "3px" }} className="w-container mx-auto text-center relative">
