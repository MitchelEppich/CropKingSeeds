      ...
      <div className="w-full h-12 inline-flex mt-6 sm:mt-6 sm:mb-6">
        <div className="w-1/2 relative ">
          <div
            ...
            className="absolute inline-flex pin-l shadow-md my-auto sm:-ml-2 rounded -ml-4">
            <p className="pl-8 pr-6 p-2 uppercase font-extrabold sm:px-2 text-lg sm:text-sm">
              +1 (604) 563-0291
            </p>
            <div className="w-12 rounded bg-yellow-dark p-2 sm:w-8 items-center flex justify-center">
              <p>
