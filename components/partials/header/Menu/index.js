...
const menu = props => {
  ...
  let isMobileNavVisible = props.misc.showMobileMenu;
  ...
  let phoneNumberPosition = ["sm"].includes(props.misc.mediaSize)
    ? { right: "-272px", backgroundColor: "#F9F9F9" }
          ...
          <div className="inline-flex w-full sm:block md:block lg:block">
            ...
            <div className="w-3/4 sm:w-full md:w-full lg:w-full flex justify-start">
              ...
              >
                ...
                {props.misc.showMobileMenu ? (
                  <div
                    style={showMobileNav}
                    className="w-full pin-l bg-red-dark fixed"
                  >
                    <ul className="text-white w-full mt-1 ml-0 pl-0 uppercase opacity-1 h-full slow">
                      <Link href="/">
                        <li className="font-extrabold text-xl pt-3 p-2 my-1 hover:bg-red-navMobile cursor-pointer slowish">
                          Home
                        </li>
                      </Link>
                      <Link href="/shop">
                      ...
                      <li
                        ...
                        className="font-extrabold text-2xl p-2 slowish hover:bg-red-navMobile cursor-pointer scale-item"
                      >
                        <CartIcon {...props} />
                      </li>
                    </ul>
