    ...
    >
      <div className="w-full h-12 inline-flex mt-6 sm:mt-2 sm:h-10 sm:mb-0">
        <div className="w-1/2 relative">
          <div
            style={viewCurrency}
            className="fixed h-12 overflow-hidden sm:h-10 pin-l bg-white shadow-md  cursor-pointer mt-10 -mr-1"
          >
            {" "}
        ...
        <div className="w-1/2">
          <a
            ...
            className="no-underline text-grey absolute inline-flex pin-r shadow-md my-auto rounded -mr-1"
          >
            ...
            <div className="w-3/4 sm:w-full md:w-full lg:w-full flex justify-start">
              ...
              <div className="sm:hidden md:hidden lg:hidden w-full">
                <ul className="flex justify-around text-white mt-1 uppercase w-full">
                  <Link href="/">
                    <li className="font-extrabold text-xl pt-3 p-2 cursor-pointer scale-item hover:text-grey">
                      Home
                    </li>
                  </Link>
                  <Link href="/shop">
