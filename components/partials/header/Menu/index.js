                    ...
                    <div className="inline-flex w-full sm:block md:block lg:block">
                            ...
                            <div
                                className={
                                    props.misc.strains != null
                                        ? "opacity-1 slow flex shadow-md -mt-54px sm:-mt-6 md:-mt-6 fixed z-999 sm:w-80px sm:h-80px md:w-80px md:h-80px w-130 h-125 rounded-full bg-crimson justify-center content-center items-center"
                                        : "opacity-0 slow flex shadow-md -mt-54px sm:-mt-6 md:-mt-6 fixed z-999 sm:w-80px sm:h-80px md:w-80px md:h-80px w-130 h-125 rounded-full bg-crimson justify-center content-center items-center"
                                }>
                                <img
                                    src="../static/img/cks-logo-header.png"
                                    onClick={() => console.log(props)}
                                    className="z-999 cks-logo-header p-0 w-125 sm:w-75px md:w-75px scale-item cursor-pointer"
                                />
                            </div>
                        </div>
                        <div className="w-3/4 sm:w-full md:w-full lg:w-full flex justify-start">
                            ...
                            <div
                                ...
                                className="justify-end w-full xl:hidden xxl:hidden unselectable">
