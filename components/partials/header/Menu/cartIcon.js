...
class Index extends Component {
    ...
    componentDidMount() {
        this.myTween = new TimelineLite({ onComplete: this.props.resetCartAnimation });
        this.myTween.pause();
    ...
    render() {
        return (
            <div ref={div => (this.myElement = div)} className="text-center cursor-pointer mt-1 text-white">
                <div>
