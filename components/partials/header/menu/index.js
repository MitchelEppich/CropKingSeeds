            ...
            <div className="p-2 w-1/2 inline-flex">      
                ...
                <div className="w-full mt-2">
                    <ul className="inline-flex w-full text-white font-bold text-2xl pt-2 pl-32">
                        <Link href="/shop">
                            <li className="px-2 py-1 mx-2 cursor-pointer text-3xl hover:text-white-dark">Shop</li>
                        </Link>
                        <Link href="/germination">
                            <li className="px-2 py-1 mx-2 cursor-pointer text-3xl hover:text-white-dark">Germination</li>
                        </Link>
                        <Link href="/articles">
                            <li className="px-2 py-1 mx-2 cursor-pointer text-3xl hover:text-white-dark">Articles</li>
                        </Link>
                    </ul>
                </div>
            </div>
