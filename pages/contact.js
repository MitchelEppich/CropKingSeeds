                    ...
                    <div className="w-full p-2 pb-12">
                        <div className="w-container mx-auto md:w-full sm:w-full lg:w-full">
                            ...
                            <p className="p-2 px-8 md:px-2 sm:px-2 mx-auto md:w-full sm:w-full w-container text-lg font-bold text-center">
                                We provide full support worldwide to address any questions or comments you may have.
                                Please view our{" "}
                                <Link prefetch href="/faq">
                                    <span className="text-red-dark cursor-pointer hover:text-grey"> FAQ Page</span>
                                </Link>{" "}
        ...
        <div className="pt-1">
          <div className="w-full p-2 pb-12">
            <div className="w-container mx-auto md:w-full sm:w-full lg:w-full">
              ...
              <p className="p-2 px-8 md:px-2 sm:px-2 mx-auto md:w-full sm:w-full w-container text-lg font-bold text-center">
                We provide full support worldwide to address any questions or
                comments you may have. Please view our{" "}
                <Link prefetch href="/faq">
              ...
              >
                ...
                <div className="p-2 w-full">
                  {!this.props.misc.emailSent ? (
                    ...
                    <p className="text-2xl font-bold w-2/3 text-left">
                      Thank you for your message! <br />A representative will
...
>>>>>>> d66d116aadeda4c04e9585ffa9fc132a8cd75248
                        </div>
                    </div>
                </div>
            </Layout>
