                                ...
                                <div className="flex flex-wrap content-start w-1/2 pl-4 md:pl-0 sm:pl-0 xl:w-1/2 lg:w-full md:w-full sm:w-full md:pt-6 md:mt-6 sm:pt-6 sm:mt-6 sm:border-t-2 sm:border-grey-lightest md:border-t-2 md:border-grey-lightest">
                                    ...
                                    <div className="mt-1 relative cursor-pointer ml-1 pl-10 sm:pl-0 lg:pl-12 md:pl-0 w-full sm:mb-8 md:mb-8">
                                        <div
                                            ...
                                            style={{
                                                width: `${150 * (this.props.viewProduct.currentProduct.rating / 5)}px`,
                                                height: "17px",
                                                marginTop: "7px"
                                            }}
                                        />
                                        <div
                                            ...
                                            style={{
                                                width: `${150 *
                                                    ((5 - this.props.viewProduct.currentProduct.rating) / 5)}px`,
                                                height: "17px",
                                                marginTop: "7px"
                                            }}
                                        />
                                            ...
                                            <AnchorLink className="items-center flex" href="#reviews">
                                                <div className="ml-2 font-bold text-sm hover:text-grey-light items-center flex sm:w-full">
                                                    {this.props.viewProduct.currentProduct.rating
                                                        ? this.props.viewProduct.currentProduct.rating.toFixed(1)
                                                        : null}{" "}
                                                    <span className="sm:hidden md:hidden mx-1 ">Crowns</span> (
                                                    {this.props.viewProduct.currentProduct.reviews
                                                        ? this.props.viewProduct.currentProduct.reviews.length
                                                        : null}{" "}
                                                    reviews)
                                                </div>
                                            </AnchorLink>
