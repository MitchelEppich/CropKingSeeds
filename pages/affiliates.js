        ...
        return (
            <Layout>
                <div className="flex flex-wrap justify-around pb-12 ">
                    <div className="affiliatesBanner mb-24">
                    ...
                    {/* <Login {...this.props} /> */}
                    <div className="mt-64 lg:mt-32 md:mt-12 sm:mt-6 sm:w-300 xxl:px-100 xl:px-50 w-full">
                        <div className="w-full sm:h-500 md:h-500 h-400 xl:h-250 lg:h-250 flex sm:flex-wrap sm:justify-center md:flex-wrap md:justify-center mx-auto justify-between bg-white rounded-lg shadow-lg overflow-hidden">
                            <div className="h-full sm:h-16 sm:pt-6 md:h-16 w-1/3 text-center md:pt-8 pt-20 lg:pt-16">
                                <img
                                    className="h-200 lg:h-100 xl:h-100 md:h-100 sm:h-100"
                                    src="../static/icons/affiliate/4.png"
                                />
                            </div>
                            <div className="w-2/3 sm:w-full md:w-full h-full">
                                <ul className="flex flex-wrap content-center h-full">
                                    <li className="w-full my-4 font-bold text-xl xl:text-base lg:text-base sm:text-base sm:pr-2 md:pr-2 flex">
                                        ...
                                        <span className="w-5/6">
                                            20% commission for a miniumum of $200 in sales. Yes, including cash sales!
                                        </span>
                                    </li>
                                    <li className="w-full my-4 font-bold text-xl xl:text-base lg:text-base sm:text-base sm:pr-2 md:pr-2 flex">
                                        <img
                    ...
                    <div className="w-1/2 xl:w-3/4 xxl:w-2/3 xxl:mb-6 lg:w-4/5 sm:my-4 lg:my-4 sm:w-full md:w-3/4 md:my-4  xl:mb-12  mx-auto">
                        <h3 className="my-4 mt-24 text-center text-3xl font-black">Affiliate Program Details</h3>
