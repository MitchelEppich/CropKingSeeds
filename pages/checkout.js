...
import { faAngleLeft, faAngleRight, faPlus, faCartPlus, faCartArrowDown } from "@fortawesome/free-solid-svg-icons";
            ...
            <Layout>
                ...
                <form
                    onSubmit={e => {
                        ...
                        if (_stepsCheckout == 4 && _orderDetails.payment.method.value == "Bitcoin") {
                            this.payBitcoin(_orderDetails, _orderDetails.payment.orderId.value.toString());
                        } else if (_stepsCheckout == 3) {
                            if (!this.props.checkout.blockedIps.includes(_orderDetails.details.ip.value)) {
                                this.props.acquireOrderId({ orderDetails: _orderDetails }).then(res => {
                            ...
                            _stepsCheckout < 4 ? this.props.toggleStepsCheckout(_stepsCheckout + 1) : null;
                        }
                    }}>
                    <div
                        style={{
                        ...
                        {_stepsCheckout == 0 ? (
                            <div>
                                ...
                                <hr style={{ border: "1px solid rgb(228, 228, 228)" }} className="my-2" />
                                <Coupon {...this.props} />
                    ...
                    <div className="w-main mx-auto">
                        <hr style={{ border: "1px solid rgba(228, 228, 228, 0.3)" }} className="" />

                        <div className="w-full inline-flex justify-between">
                            <div
                                onClick={() => {
                                    _stepsCheckout > 0 ? this.props.toggleStepsCheckout(_stepsCheckout - 1) : null;
                                }}
