                ...
                {this.props.misc.ageVerification == null || !this.props.misc.ageVerification.verified ? (
                    ...
                    <React.Fragment>
                        ...
                        <div className="pt-32">
                            ...
                            <div className="bg-white relative z-30 px-4 md:mt-20 sm:mt-12 py-4 w-full xxl:w-1300 xl:w-900 lg:w-700 md:w-main mx-auto shadow-md">
                        ...
                        <div
                            className="pulse fixed z-999 w-20 mb-48 h-16 bg-red-darker pin-b pin-l text-white text-center text-lg pt-3 pr-3 rounded-tr-full rounded-br-full cursor-pointer hover:bg-red-dark scale-item shadow-md"
