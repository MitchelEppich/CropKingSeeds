...
<title>iDevAffiliate Administrative Center</title>
...
<div class="content">
	...
	<strong><font style="font-size:16px;"><?PHP echo $reset_message_1; ?></font></strong><br /><?PHP echo $reset_message_2; ?>
	</div>
	<?PHP } ?>
...
<br />
<p class="pull-right">iDevAffiliate Version <?PHP echo $version; ?></p><br />
