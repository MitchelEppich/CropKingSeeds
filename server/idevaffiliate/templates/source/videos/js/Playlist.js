                ...
                if(options.onFinish=="Play next video")
                {
                    ...
                    else if(options.videos[self.videoid].videoType=="vimeo" || options.videoType=="Vimeo")
                    {
                        ...
                        if(self.CLICK_EV=="click")
                            if(self.VIDEO.shuffleBtnEnabled)
                                document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[self.randEnd].vimeoID+"?autoplay=1?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
                            else
                                document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[self.videoid].vimeoID+"?autoplay=1?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
            ...
            if(options.onFinish=="Play next video")
            {
                ...
                else if(options.videos[self.videoid].videoType=="vimeo" || options.videoType=="Vimeo")
                {
                    ...
                    if(!self.hasTouch){
						...
						if(self.VIDEO.shuffleBtnEnabled)
							document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[self.randEnd].vimeoID+"?autoplay=0?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
						else
							document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[self.videoid].vimeoID+"?autoplay=0?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
                    }
                }
            }
            else if(options.onFinish=="Restart video")
    ...
    $(options.videos).each(function loopingItems()
    {
        ...
        else if(options.videos[0].videoType=="vimeo" || options.videoType=="Vimeo")
        {
            ...
            if(!self.hasTouch){
                if(options.autoplay){
					if(options.loadRandomVideoOnStart=="Yes")
						document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[self.rand].vimeoID+"?autoplay=1?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
					else
						document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[0].vimeoID+"?autoplay=1?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
				}
                else{
					if(options.loadRandomVideoOnStart=="Yes")
						document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[self.rand].vimeoID+"?autoplay=0?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
					else
						document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+self.videos_array[0].vimeoID+"?autoplay=0?api=1&player_id=vimeo_video"+"&color="+options.vimeoColor;
				}
            }
            else{
                if(options.loadRandomVideoOnStart=="Yes")
...
PLAYER.Playlist.prototype = {
    ...
    playVimeo:function(obj_id){
        ...
        if(!this.hasTouch){
            document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+this.videos_array[obj_id].vimeoID+"?autoplay=1?api=1&player_id=vimeo_video"+"&color="+this.options.vimeoColor;
        }
        else{
            document.getElementById("vimeo_video").src ="//player.vimeo.com/video/"+this.videos_array[obj_id].vimeoID+"?autoplay=0?api=1&player_id=vimeo_video"+"&color="+this.options.vimeoColor;
        }
    }
