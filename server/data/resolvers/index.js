...
let processPivotal = async input => {
      ...
      let res = JSON.parse(convert.xml2json((await axios({
        method: "post",
        headers: {
        ...
        data: (toXML(content))
      })).data, {compact: true, spaces: 4}))["PAYMENTRESPONSE"]
