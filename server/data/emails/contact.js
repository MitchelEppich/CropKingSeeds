exports.contact = input => {
  ...
  if (["Event Sponsorship", "Wholesale Inquiry"].includes(input.subject))
    recipient = "fhelipe@vancoastind.com";
  return {
    from: input.email,
    to: "fhelipe@vancoastind.com", //recipient,
    recipient,
   ...
   <style type="text/css">
    ...
    <table style="background: #fff; border: 0" class="tg">
     <tr>
        <td style="width: 200px; text-size: 15px; margin: 10px 0;" class="tg-0lax bold">Hello, We've got a new email!</td>        
      </tr>       
